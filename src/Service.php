...
use nandorodpires\yii2\aws\s3\interfaces\HandlerResolver;
use nandorodpires\yii2\aws\s3\interfaces\Service as ServiceInterface;
...
class Service extends Component implements ServiceInterface
{
     ...
     *
     * @return \nandorodpires\yii2\aws\s3\CommandFactory
     */
     ...
     *
     * @return \nandorodpires\yii2\aws\s3\interfaces\HandlerResolver
     */
    ...
    protected function defaultComponentDefinitions()
    {
        return [
            ...
            'resolver' => ['class' => 'nandorodpires\yii2\aws\s3\HandlerResolver'],
            'bus' => ['class' => 'nandorodpires\yii2\aws\s3\Bus'],
            'builder' => ['class' => 'nandorodpires\yii2\aws\s3\CommandBuilder'],
            'factory' => ['class' => 'nandorodpires\yii2\aws\s3\CommandFactory'],
        ];
    }
