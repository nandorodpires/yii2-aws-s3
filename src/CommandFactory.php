...
use nandorodpires\yii2\aws\s3\commands\DeleteCommand;
use nandorodpires\yii2\aws\s3\commands\ExistCommand;
use nandorodpires\yii2\aws\s3\commands\GetCommand;
use nandorodpires\yii2\aws\s3\commands\GetPresignedUrlCommand;
use nandorodpires\yii2\aws\s3\commands\GetUrlCommand;
use nandorodpires\yii2\aws\s3\commands\PutCommand;
use nandorodpires\yii2\aws\s3\commands\RestoreCommand;
use nandorodpires\yii2\aws\s3\commands\UploadCommand;
use nandorodpires\yii2\aws\s3\commands\ListCommand;
...
class CommandFactory
{
    /** @var \nandorodpires\yii2\aws\s3\interfaces\CommandBuilder */
    protected $builder;

    /**
     * CommandFactory constructor.
     *
     * @param \nandorodpires\yii2\aws\s3\interfaces\CommandBuilder $builder
     */
     ...
     *
     * @return \nandorodpires\yii2\aws\s3\commands\GetCommand
     */
     ...
     * @param mixed  $body
     *
     * @return \nandorodpires\yii2\aws\s3\commands\PutCommand
     */
     ...
     * @param string $filename
     *
     * @return \nandorodpires\yii2\aws\s3\commands\DeleteCommand
     */
     ...
     * @param mixed  $source
     *
     * @return \nandorodpires\yii2\aws\s3\commands\UploadCommand
     */
     ...
     *
     * @return \nandorodpires\yii2\aws\s3\commands\RestoreCommand
     */
     ...
     * @param string $filename
     *
     * @return \nandorodpires\yii2\aws\s3\commands\ExistCommand
     */
     ...
     * @param string $prefix
     *
     * @return \nandorodpires\yii2\aws\s3\commands\ListCommand
     */
     ...
     * @param string $filename
     *
     * @return \nandorodpires\yii2\aws\s3\commands\GetUrlCommand
     */
     ...
     * @param mixed  $expires
     *
     * @return \nandorodpires\yii2\aws\s3\commands\GetPresignedUrlCommand
     */
